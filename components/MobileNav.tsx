      ...
      {open &&
        ...
        createPortal(
          ...
          >
            ...
            />
            <div className="absolute left-0 top-0 flex h-full w-[82%] max-w-xs flex-col overflow-y-auto overscroll-contain border-r border-border bg-card p-4 shadow-2xl animate-in slide-in-from-left">
